...
array("name" => "Site Mobile Logo",
    ...
    array("type" => "close"),
/* =Inner Page Bnner Settings------------------------------------------------------------------------------------------------------------------------------*/
		
		
		array("name" => "Inner Page Bnner Settings",
				...
				array("name" => "Portfolio",
        			...
        			"std" => ""),
		array("name" => "Portfolio Banner Text",
		
				"desc" => "Portfolio Banner Text Here",
		...
		array("name" => "Service Page Bnner",
				...
				"std" => ""),
		array("name" => "Service Banner Text",
		
				"desc" => "Service Banner Text Here",
		...
		array("name" => "who we Page Bnner",
				...
				"std" => ""),
		array("name" => "who we Banner Text",
		
				"desc" => "who we Banner Text Here",
				...
				"std" => ""),
		array("name" => "Our Solution Page Bnner",
				...
				"std" => ""),
		array("name" => "Our Solution Banner Text",
				...
				"std" => ""),
		array("name" => "Contact Us Page Bnner",
				...
				"std" => ""),
		array("name" => "Contact Us Banner Text",
		
				"desc" => "Contact Us Text Here",
				...
				"std" => ""),
		array("name" => "Testimonials  Page Bnner",
				...
				"std" => ""),
		array("name" => "Testimonials Banner Text",
		...
		array("name" => "Contact  Information",
				...
				array("name" => "Phone Number",
						...
						array("name" => "Mobile Number",
								...
								array("name" => "E-Mail Address(Contact Us page)",
		
												"desc" => "Enter E-Mail Address Here",
...
/* =Social Media Settings
 ...
 ------------------------------------------------------------------------------------------------------------------------------*/
    ...
    array("name" => "Google Pluse",
          
          "id" => $shortname . "_gpluse",
...
function mytheme_add_admin()
{
    ...
    add_menu_page($themename, $themename, 'administrator', basename(__FILE__), 'mytheme_admin','dashicons-desktop');
...
case 'textarea':
    ...
    <div class="am_input am_textarea">
        ...
        <div class="texted"><textarea id="<?php echo $value['id']; ?>" name="<?php echo $value['id']; ?>"
...
case 'textarea2':
    ...
    <div class="am_input am_textarea">
        ...
        <div class="texted"><textarea name="<?php echo $value['id']; ?>" type="<?php echo $value['type']; ?>" cols=""
                                      rows=""><?php if (get_settings($value['id']) != "") {
                    echo stripslashes(get_settings($value['id']));
                } else {
                    echo $value['std'];
...
<div class="rm_input rm_upload">
    ...
    <p class="awdMetaImage" style="padding-left:15px; max-width:720px;overflow: auto;"><img
            src="<?php if (get_settings($value['id']) != "") {
                echo stripslashes(get_settings($value['id']));
            } else {
                echo $value['std'];
            } ?>" style="max-width: 100%;"/>
    ...
    <p>
        ...
        <input type="text" class="upload-url <?php $field_class ?>" name="<?php echo $value['id']; ?>"
               id="<?php echo $value['name']; ?>" value="<?php if (get_settings($value['id']) != "") {
            echo stripslashes(get_settings($value['id']));
        } else {
            echo $value['std'];
        } ?>"/>
...
<div class="am_section">
    ...
    <div class="am_title">
        ...
        <h3><img src="<?php bloginfo('template_directory') ?>/optionpage/images/trans.png" class="inactive"
                 alt="""><?php echo $value['name']; ?></h3>
